      ...
      <Grid container spacing={3}>
        {tipoPessoa === '1' && (
          <>    
            ...
            <Grid xs={12} sm={3}>
              <TextField name="dataNascimento" label="Data de Nascimento" type="date" value={formData.dataNascimento} onChange={handleChange} fullWidth InputLabelProps={{ shrink: true }} />
            </Grid>
          </>
        )}

      ...
      {data.length > 0 ? (
        <Box sx={{ width: '100%', mt: 2, height: chartHeight + 50 }}>
          <BarChart
            ...
            sx={{
              '& .MuiBarElement-root': { rx: 6, stroke: alpha(theme.palette.success.main, 0.5), strokeWidth: 1 },
              width: '100%'
            }}
          />
        </Box>
        ...
        <Box display="flex" justifyContent="center" alignItems="center" height={chartHeight}>
          <Typography variant="body2" color="text.secondary">Nenhuma receita.</Typography>
        </Box>
      )}

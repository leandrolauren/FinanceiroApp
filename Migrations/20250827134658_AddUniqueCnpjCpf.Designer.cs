...
namespace FinanceiroApp.Migrations
{
    ...
    [Migration("20250827134658_AddUniqueCnpjCpf")]
    partial class AddUniqueCnpjCpf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceiroApp.Models.PessoaModel", b =>
                {
                    ...
                    b.HasIndex(new[] { "UsuarioId", "Cnpj" }, "IX_Pessoa_Usuario_Cnpj")
                        .IsUnique()
                        .HasFilter("\"Cnpj\" IS NOT NULL");

                    b.HasIndex(new[] { "UsuarioId", "Cpf" }, "IX_Pessoa_Usuario_Cpf")
                        .IsUnique()
